...
function CollectionPage() {
    ...
    const showWallets = async () => {
        const allWallets = await APII.getAllWALedgers(user_id);
                ...
                <View style={{flexDirection:'column',marginTop:('10%'),paddingHorizontal:'5%'}} >
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}} >
                        ...
                        <View style={{flexDirection:'column'}} >
                            <Text style={{fontSize:30, fontWeight:'bold',color : themeColor}} >Ledgers</Text>
                        </View>
                                ...
                                <TouchableOpacity> 
                                    <View style={{flexDirection:'row',height:hp('10%'),width:'100%',backgroundColor:'rgba(66,95,235,255)',borderRadius:15,justifyContent:'space-between',paddingRight:10,marginBottom:10}} >
                                        ...
                                        <View style={{flexDirection:'row',alignItems:'center'}} >
                                            ...
                                            <Image style={{height:'60%'}} resizeMode="contain" source={require('../assets/icons/TransactionRecords.png')} />

                                            <View style={{flexDirection:'column',justifyContent:'flex-start'}} >
                                                <Text style={{marginLeft:20, fontWeight: '500',color:'white',fontSize:20}} >{item.ledger_name}</Text>
                                            </View>
